...
function cerrar()
{
   if(confirm("¿Desea realmente cerrar la sesión?"))
   {
...
function entrar()
{
 ...
 {
  alert('Debe escribir el login del usuario y la contraseña');
 }
 else
 {
...
<div  class="curved loginn" >
  ...
  <p class="us" align="center">USUARIO: <?PHP echo $_SESSION['login'];?></p> <p align="center">
			...
			&nbsp;<p align="center"><input type="button" value="Cerrar sesión" name="B1" onclick="cerrar()"> </p> 
			<?php
