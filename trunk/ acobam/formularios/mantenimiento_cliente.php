...
<h1>MANTENIMIENTO DE CLIENTES<br />
</h1>
<form name="buscar" method="post" >
<input type="hidden" name="accion" value="buscar" />
<!-- Primer Cuadrito -->
    <div style="text-align: center">
        <label>C&oacute;digo de Motorista</label>
        <input type="text" size="5" maxlength="5" name="id_cliente" />
        <input type="submit" class="curvita" value="Buscar" />
        <a href="../archivos/clientes.php" target="_blank"><input type="button" class="curvita" value="Ver" /></a>
    </div>
...
<form name="form" method="post">
    ...
    <div >
        ...
        <tr>        
          ...
          <td class="control"><input type="text" class="sexo" name="sexo" /></td>
        </tr>
        <tr>
		  <td colspan="2">
		  <p align="center"><input type="submit" value="Guardar" name="boton" onclick="validarvacios()" tabindex="9" ></td>
		</tr>
		<tr>
...
<?php include '../archivos/actualizar_cliente.php'; ?>