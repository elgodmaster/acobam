...
<div id="contenedor"> <!-- dentro de contenedor va el contenido de la pagina -->
	<div id="banner"> <!-- encabezado de la pagina web --> <img src="../imagenes/Captura.PNG" alt="Menu" width="1000" height="100"  align="top"  /> 
	</div>
    <br>
	<div id="menu"  align="center" class="menu"> <!-- este div es la barra de navegacion (menu) -->
	  <a class="menu"  href="../index.html">| Principal |</a>
	  <a class="menu" href="servicios.php">| Servicios |</a>
	  <a class="menu" href="destinos.html">| Destinos |</a>
  	  <a class="menu" href="loginCliente.php">| Cerrar sesi&oacute;n |</a>
...
<td>
<a href="turnos.php">
<img src="../imagenes/librito.png"  width="128" height="128" alt="">
</a>
<br>Reservaci&oacute;n
</td>
