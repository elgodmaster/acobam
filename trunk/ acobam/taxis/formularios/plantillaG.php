...
<div id="contenedor"> <!-- dentro de contenedor va el contenido de la pagina -->
 ...
 <img src="../imagenes/Captura.PNG" alt="Menu" width="1000" height="100"  align="top"  /> 
	...
	<div id="menu"  align="center" class="menu"> <!-- este div es la barra de navegacion (menu) -->
	  ...
	  <a class="menu" href="reporte_motoristas.php">| Reporte de motoristas |</a>
	  <a class="menu" href="reporte_empleado.php">| Reporte de empleados |</a>
  	  <a class="menu" href="tabla_en_pdf.php" target="_blank">| Reporte de clientes |</a>
      <a class="menu" href="ayuda.php">| Ayuda |</a>
       <a class="menu" href="deslogin.php">| Cerrar Seci&oacute;n|</a>
     </div>
...
<img src="../imagenes/artleo.com-7997.jpg" width="350" height="150" />
</td>
